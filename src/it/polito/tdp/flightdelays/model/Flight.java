...
public class Flight {
	...
	public Flight(Airline airline, Airport sourceAirport, Airport destinationAirport, double avg) {
		this.airline = airline;
		this.a1 = sourceAirport;
		this.a2 = destinationAirport;
		this.avg = avg;
	}
	...
	public void setAil(Airline ail) {
		this.airline = ail;
	}
